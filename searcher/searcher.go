...
import (
	...
	"github.com/mapix/hound/config"
	"github.com/mapix/hound/index"
	"github.com/mapix/hound/vcs"
)
...
func updateAndReindex(
	...
	repo := s.Repo
	newRev, err := wd.PullOrClone(vcsDir, repo.GetClonableUrl())
...
func newSearcher(
	...
	rev, err := wd.PullOrClone(vcsDir, repo.GetClonableUrl())
	if err != nil {
		return nil, err
	}
